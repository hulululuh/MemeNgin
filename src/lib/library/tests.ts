...
export class TestGradientNode extends ImageDesignerNode {
  init() {
...
export class TestInvertNode extends ImageDesignerNode {
  init() {
    this.title = "Invert";
...
export class TestMultiplyNode extends ImageDesignerNode {
  init() {
    this.title = "Multiply";
...
export class TestShapeNode extends ImageDesignerNode {
  init() {
    this.title = "Shape";
...
export class TestWorleyNode extends ImageDesignerNode {
  init() {
    this.title = "Worley";
    //this.exportName = "result";
...
export class TestNormalNode extends ImageDesignerNode {
  init() {
...
export class TestWarpNode extends ImageDesignerNode {
  init() {
    this.title = "Warp";
...
export class TestSimplexNode extends ImageDesignerNode {
  init() {
...
export class TestBrickNode extends ImageDesignerNode {
  init() {
    this.title = "Brick";
